...
aries_cloudagent \
start \
--endpoint http://10.1.0.189:8034 \
--label Mediator.Agent.8035 \
--auto-ping-connection \
--auto-respond-messages \
--inbound-transport http 0.0.0.0 8034 \
--outbound-transport http \
--admin 0.0.0.0 8035 \
--admin-insecure-mode \
--wallet-type askar \
--wallet-name mediator.agent.8035899231 \
--wallet-key Mediator.Agent.8035899231 \
--preserve-exchange-records \
--auto-provision \
--public-invites \
--emit-new-didcomm-prefix \
--webhook-url http://10.1.0.189:8036/webhooks \
--monitor-revocation-notification \
--trace-target log \
--trace-tag acapy.events \
--trace-label Mediator.Agent.8035.trace \
--open-mediation \
--auto-accept-invites \
